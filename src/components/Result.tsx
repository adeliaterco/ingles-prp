...
export default function Result({ onNavigate }: ResultProps) {
    ...
    useEffect(() => {
        ...
        const timerPhase1 = setTimeout(() => {
            ...
            ga4Tracking.revelationViewed('Why they left you', 1);
            ...
            if (vslPlaceholder) {
                ...
                vslPlaceholder.innerHTML = `
                    ...
                    <div style="position: relative; width: 100%; max-width: 400px; margin: 0 auto; aspect-ratio: 9 / 16; background: #000; border-radius: 8px; overflow: hidden;">
                        ...
                        <vturb-smartplayer id="vid-69bae583891545b57a92ba0b" style="display: block; width: 100%; height: 100%; position: absolute; top: 0; left: 0;"></vturb-smartplayer>

                    </div>

                `;

                if (!document.querySelector('script[src*="69bae583891545b57a92ba0b"]')) {

                    const s = document.createElement("script");

                    s.src = "https://scripts.converteai.net/52018b5b-3f47-42a3-b3df-1e325329b52a/players/69bae583891545b57a92ba0b/v4/player.js";
    ...
    const handlePhase2ButtonClick = () => {
        ...
        setTimeout(() => {
            ...
            ga4Tracking.phaseProgressionClicked({ phase_from: 2, phase_to: 3, button_name: 'Reveal THE 72-HOUR WINDOW' });
            ...
            <div className="revelations-container">
                    ...
                    >
                        ...
                        <div className="ventana-scientific-intro">
                            ...
                            <p>
                                ...
                                Studies from Harvard and Nature Neuroscience confirm: there are neurochemical windows of 72 hours where your ex's brain multiplies its emotional receptivity (dopamine, oxytocin, attachment).

                                <strong> This is the scientific foundation of the process you're about to see.</strong>
                ...
                {currentPhase === 4 && (
                    ...
                    >
                        ...
                        <p style={{
                            ...
                            You know your diagnosis.<br/>

                            You've seen the 72-Hour Window.<br/>

                            You know that <strong style={{ color: '#facc15' }}>this works</strong>.<br/><br/>
                ...
                {currentPhase >= 4 && (
                    ...
                    <div ref={offerSectionRef} className="revelation fade-in offer-section-custom">
                        ...
                        {/* ✅ MELHORIA #4: Social proof statistics */}
                        ...
                        <div style={{
                            ...
                            <h3 style={{
                                ...
                                Join the 9,247+ people who got their ex back
                        ...
                        <h2 style={{
                            ...
                            Get Back {gender === 'MALE' ? 'The Woman You Love' : 'The Man You Love'}
                        ...
                        <p style={{
                            ...
                            (Or We Refund 100% Of Your Money)

                        </p>

                        {/* ✅ MELHORIA #5: 2 Plans side by side ($14 / $27) */}
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                {/* Critical cases notice INSIDE $27 card */}
                                ...
                                <div style={{
                                    ...
                                    <p style={{
                                        ...
                                        ⚠️ Critical cases (ex with someone else): 73% choose this plan
                                ...
                                <div style={{ marginBottom: 'clamp(14px, 3.5vw, 18px)' }}>
                                    ...
                                    <p style={{ fontSize: 'clamp(0.9rem, 3.5vw, 1.05rem)', color: 'rgba(255,255,255,0.8)', margin: 0 }}>
                                        ...
                                        For critical cases (ex with someone else)
                                ...
                                <div style={{ marginBottom: 'clamp(20px, 4vw, 24px)', flex: 1 }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                        ...
                                        <div style={{ fontSize: 'clamp(0.95rem, 3.8vw, 1.1rem)', color: '#4ade80', fontWeight: '700' }}>✅ EVERYTHING in the Essential Plan +</div>
                                        ...
                                        <div style={{ fontSize: 'clamp(0.95rem, 3.8vw, 1.1rem)', color: '#4ade80', fontWeight: '700' }}>🔥 Bonus: Guide "How To Read Their Mind"</div>
                        ...
                        {/* ✅ MELHORIA #6: 2 Testimonials (Mateo + Pablo) */}
                        ...
                        <div style={{
                            ...
                            <h2 style={{
                                ...
                                What People Who Got Their Ex Back Are Saying
                                ...
                                <div style={{
                                    ...
                                    <div style={{ flex: 1, minWidth: '200px' }}>
                                        ...
                                        <p style={{
                                            ...
                                            "I'd give it ten out of five stars! At first I was skeptical about the program. I thought the reviews were fake and I had completely lost hope with my girlfriend. She was already with another guy and I was devastated. We couldn't talk without fighting, and now 4 days after starting the program, using what I learned from Module 4 (Emergency Protocol), it's not perfect but we're back together and willing to do everything to make it work. Module 4 saved me from making fatal mistakes."
                        ...
                        {/* ✅ MELHORIA #7: 3 benefits/transformations section */}
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <p style={{
                                        ...
                                        Extremely powerful techniques to <strong style={{ color: '#4ade80' }}>activate their oxytocin</strong>, tailored to your relationship profile
                                ...
                                <div style={{
                                    ...
                                    <p style={{
                                        ...
                                        They will be <strong style={{ color: '#4ade80' }}>helplessly and uncontrollably attracted</strong> to you
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                If within 30 days you don't see <strong style={{ color: '#4ade80' }}>concrete results</strong> in your reconquest 

                                (messages from {gender === 'MALE' ? 'her' : 'him'}, attitude change, reconnection), 
                        ...
                        {/* ✅ MELHORIA #10: Expanded FAQ (4 questions) */}
                            ...
                            <div style={{
                                ...
                                <details style={{
                                    ...
                                    <summary style={{
                                        ...
                                        ❓ Does it work if {gender === 'MALE' ? 'she\'s already with someone else' : 'he\'s already with someone else'}?
                                    ...
                                    <p style={{
                                        ...
                                        was created specifically for that situation. It has already saved +2,100 cases where {gender === 'MALE' ? 'she was with another guy' : 'he was with someone else'}.
                                ...
                                <details style={{
                                    ...
                                    <p style={{
                                        ...
                                        Most people see the first changes (messages, looks, signals) 

                                        between day 7 and 21. Emergency cases may take up to 45 days.
                                ...
                                <details style={{
                                    ...
                                    <p style={{
                                        ...
                                        Complete the daily tasks, give feedback, and study the materials. We've designed the plan so that <strong style={{ color: '#4ade80' }}>every day brings you closer to your goal</strong>, step by step.
                                ...
                                <details style={{
                                    ...
                                    <p style={{
                                        ...
                                        Don't worry! Our plan is designed to <strong style={{ color: '#4ade80' }}>build motivation gradually</strong>, so you won't have to rely on it too much from the start. Plus, we're here to provide <strong style={{ color: '#4ade80' }}>constant support</strong> and expert guidance.
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                <span style={{ fontSize: 'clamp(0.8rem, 3vw, 0.95rem)', opacity: 0.8 }}>
                                    ...
                                    ✨ {peopleBuying} people buying right now
