...
export default function Chat({ onNavigate }: ChatProps) {
  ...
  useEffect(() => {
    ...
    const initialMessage: Message = {
      type: 'bot',
      text: 'Hello. I\'m Sara Mitchell, a specialist in reconnection through behavioral psychology. My system detected your search for answers. I\'m here to analyze your case.',
      isTyping: true,
    };
